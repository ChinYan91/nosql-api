...
const { validateRegistration, validateLogin, validateChangePassword, validateUserID } = require('../app.middlewares/user.validator');
...
router.delete('/delete', auth, validateUserID, (req, res, next) => { UserController.delete(req, res) })
